...
function goalsEducationCard(){
  return `
    <section class="edu-card edu-card-goals" aria-label="Образовательная карточка Цель и задачи">
      <div class="edu-card-head">
        <span class="edu-card-kicker">Перед заполнением</span>
        <h3>Цель отвечает «что изменится», задачи — «как к этому прийти»</h3>
        <p>Цель фиксирует конкретное изменение для аудитории, а задачи раскладывают путь к нему на крупные направления работы. Мероприятия позже покажут действия внутри каждой задачи, а результаты подтвердят их выполнение.</p>
      </div>

      <div class="edu-expert-box">
        <div class="edu-box-title">Что хотят увидеть эксперты</div>
        <div class="edu-expert-grid">
          <span>конкретное изменение для выбранной аудитории</span>
          <span>прямую связь цели с доказанной проблемой</span>
          <span>достаточный набор крупных задач</span>
          <span>возможность раскрыть задачи через мероприятия</span>
          <span>проверяемый результат для каждой задачи</span>
        </div>
      </div>
      ...
      <div class="edu-examples">
        <article class="edu-example edu-example-good">
          <div class="edu-example-label">Хороший пример</div>
          <p><b>Цель:</b> повысить готовность 40 подростков 14–17 лет из округа Новые Берега к осознанному выбору образовательной траектории через практическое знакомство с профессиями.</p>
          <p><b>Задачи:</b></p>
          <ol>
            <li>Разработать программу профессиональных проб с учётом потребностей подростков.</li>
            <li>Организовать прохождение участниками цикла проб с наставниками.</li>
            <li>Помочь подросткам проанализировать опыт и определить дальнейшие шаги.</li>
          </ol>
          <small>Почему сильный: цель описывает изменение и отвечает на проблему, а задачи показывают крупные шаги, которые можно раскрыть через мероприятия и подтвердить результатами.</small>
        </article>
        <article class="edu-example edu-example-weak">
          <div class="edu-example-label">Слабый пример</div>
          <p><b>Цель:</b> провести профориентационные мероприятия и повысить интерес молодёжи. <b>Задачи:</b> провести лекцию, мастер-класс, встречу с экспертом и итоговое мероприятие.</p>
          <small>Почему слабый: цель смешивает действие с неопределённым изменением, а задачи заменены перечнем мероприятий. Непонятно, как они решают проблему и какой результат подтвердит успех.</small>
        </article>
      </div>
      ...
      <div class="edu-support-grid">
        <div class="edu-support-card">
          <div class="edu-box-title">Типичные ошибки</div>
          <ul>
            <li>описывать цель как процесс или мероприятие;</li>
            <li>объединять в цели несколько несвязанных изменений;</li>
            <li>повторять цель в задачах, не раскрывая путь к ней;</li>
            <li>превращать задачи в перечень отдельных событий;</li>
            <li>не связывать задачи с мероприятиями и результатами.</li>
          </ul>
        </div>
        <div class="edu-support-card">
          <div class="edu-box-title">Самопроверка</div>
          <ul class="edu-check-list">
            <li>Отвечает ли цель на вопрос, что изменится и для кого?</li>
            <li>Следует ли цель из описанной проблемы?</li>
            <li>Достаточно ли выбранных задач для достижения цели?</li>
            <li>Являются ли задачи крупными шагами, а не мероприятиями?</li>
            <li>Можно ли связать каждую задачу с действиями и проверяемым результатом?</li>
          </ul>
        </div>
      </div>
      ...
      <div class="edu-work-link">
        <b>Как работать дальше:</b>
        <span>сначала сформулируйте одно изменение, которое отвечает на проблему выбранной аудитории. Затем определите 3–4 крупные задачи и для каждой предусмотрите будущие мероприятия и проверяемый результат.</span>
      </div>
    </section>
  `;
}

function implementationEducationCard(){
  return `
    <section class="edu-card edu-card-implementation" aria-label="Образовательная карточка Реализация">
      <div class="edu-card-head">
        <span class="edu-card-kicker">Перед заполнением</span>
        <h3>План реализации переводит задачи в конкретные действия</h3>
        <p>Задача задаёт крупный шаг, а мероприятие показывает, что именно будет сделано для его выполнения. Мероприятия нужно выстроить в последовательные этапы с понятными сроками, местом и ответственными.</p>
      </div>

      <div class="edu-expert-box">
        <div class="edu-box-title">Что хотят увидеть эксперты</div>
        <div class="edu-expert-grid">
          <span>связь каждого мероприятия с конкретной задачей</span>
          <span>логичный порядок этапов и зависимостей</span>
          <span>понятные сроки, форматы и территорию</span>
          <span>реалистичный объём действий и распределение ответственности</span>
          <span>реалистичные условия реализации проекта</span>
        </div>
      </div>
      ...
      <div class="edu-examples">
        <article class="edu-example edu-example-good">
          <div class="edu-example-label">Хороший пример</div>
          <p><b>Подготовка — март:</b> координатор и наставники разрабатывают программу профессиональных проб, согласуют площадки и проводят набор подростков.</p>
          <p><b>Основной этап — апрель–май:</b> 40 участников проходят цикл из четырёх проб с практическими заданиями и обратной связью наставников.</p>
          <p><b>Завершение — июнь:</b> подростки анализируют полученный опыт и определяют дальнейшие образовательные шаги; команда собирает обратную связь участников.</p>
          <small>Почему сильный: каждый этап выполняет одну из задач проекта, действия идут в необходимом порядке, а сроки и ответственность понятны.</small>
        </article>
        <article class="edu-example edu-example-weak">
          <div class="edu-example-label">Слабый пример</div>
          <p>В течение года планируется провести лекции, мастер-классы, встречи, конкурс, фестиваль и информационную кампанию. Точные сроки, площадки и ответственные будут определены позднее.</p>
          <small>Почему слабый: мероприятия перечислены без связи с задачами и аудиторией, последовательность отсутствует, а реалистичность плана невозможно оценить.</small>
        </article>
      </div>
      ...
      <div class="edu-support-grid">
        <div class="edu-support-card">
          <div class="edu-box-title">Типичные ошибки</div>
          <ul>
            <li>добавлять мероприятия, которые не выполняют задачи;</li>
            <li>перечислять форматы без содержания и аудитории;</li>
            <li>пропускать подготовку и зависимости между этапами;</li>
            <li>перегружать сроки или оставлять задачи без действий;</li>
            <li>не учитывать ответственных, территорию, условия и риски.</li>
          </ul>
        </div>
        <div class="edu-support-card">
          <div class="edu-box-title">Самопроверка</div>
          <ul class="edu-check-list">
            <li>Какую задачу выполняет каждое мероприятие?</li>
            <li>Достаточно ли действий и нет ли среди них лишних?</li>
            <li>Понятны ли порядок этапов и зависимости между ними?</li>
            <li>Реалистичны ли сроки с учётом территории и условий?</li>
            <li>Может ли эксперт представить, кто, что и когда будет делать?</li>
          </ul>
        </div>
      </div>
      ...
      <div class="edu-work-link">
        <b>Как работать дальше:</b>
        <span>расположите необходимые мероприятия по этапам — от подготовки до завершения проекта. Когда план станет последовательным и выполнимым, переходите к описанию результатов.</span>
      </div>
    </section>
  `;
}

function resultsEducationCard(){
  return `
    <section class="edu-card edu-card-results" aria-label="Образовательная карточка Результаты">
      <div class="edu-card-head">
        <span class="edu-card-kicker">Перед заполнением</span>
        <h3>Результат — это подтверждённое изменение, а не проведённое мероприятие</h3>
        <p>Количественные результаты показывают, сколько участников охвачено или что создано, а качественные — что изменилось у аудитории. Эффект описывает более широкое последствие проекта, и для каждого результата нужен способ подтверждения.</p>
      </div>

      <div class="edu-expert-box">
        <div class="edu-box-title">Что хотят увидеть эксперты</div>
        <div class="edu-expert-grid">
          <span>конкретные и реалистичные количественные показатели</span>
          <span>изменения у определённой целевой аудитории</span>
          <span>связь результатов с проблемой и целью проекта</span>
          <span>обоснованный эффект без завышенных обещаний</span>
          <span>заранее выбранные способы подтверждения</span>
        </div>
      </div>
      ...
      <div class="edu-examples">
        <article class="edu-example edu-example-good">
          <div class="edu-example-label">Хороший пример</div>
          <p><b>Количественные результаты:</b> 40 подростков пройдут цикл из четырёх профессиональных проб и подготовят личные карты дальнейших образовательных шагов.</p>
          <p><b>Качественные изменения:</b> не менее 30 участников смогут определить подходящие профессиональные направления и дальнейшие образовательные шаги.</p>
          <p><b>Эффект:</b> в округе появится доступная практика знакомства подростков с профессиями через реальный опыт, а не только беседы и тесты.</p>
          <p><b>Подтверждение:</b> регистрация и посещаемость, личные карты участников, анкеты до и после цикла, обратная связь подростков и наставников.</p>
          <small>Почему сильный: показатели относятся к конкретной аудитории, следуют из реализации проекта и позволяют проверить не только участие, но и произошедшее изменение.</small>
        </article>
        <article class="edu-example edu-example-weak">
          <div class="edu-example-label">Слабый пример</div>
          <p>Будут проведены четыре мастер-класса для 40 подростков. Проект повысит интерес молодёжи к профессиям, поможет раскрыть потенциал и сделать правильный выбор.</p>
          <small>Почему слабый: количество мероприятий и участников не доказывает изменение. Качественный результат сформулирован общими словами, а способ его измерения не указан.</small>
        </article>
      </div>
      ...
      <div class="edu-support-grid">
        <div class="edu-support-card">
          <div class="edu-box-title">Типичные ошибки</div>
          <ul>
            <li>считать проведённые мероприятия конечным результатом;</li>
            <li>указывать только цифры без изменений у участников;</li>
            <li>использовать общие формулировки без связи с аудиторией;</li>
            <li>обещать масштабный эффект, недостижимый за срок проекта;</li>
            <li>не определять показатели и способы подтверждения заранее.</li>
          </ul>
        </div>
        <div class="edu-support-card">
          <div class="edu-box-title">Самопроверка</div>
          <ul class="edu-check-list">
            <li>Какие результаты проекта можно точно посчитать?</li>
            <li>Что изменится у аудитории, кроме факта участия?</li>
            <li>Отвечают ли результаты заявленной проблеме и цели?</li>
            <li>Какими данными можно подтвердить произошедшее изменение?</li>
            <li>Реалистично ли получить эти результаты благодаря запланированным мероприятиям?</li>
          </ul>
        </div>
      </div>
      ...
      <div class="edu-work-link">
        <b>Как работать дальше:</b>
        <span>разделите ожидаемые итоги на показатели, изменения и более широкий эффект, затем определите способ подтверждения каждого из них. После этого переходите к команде и проверяйте, способна ли она обеспечить эти результаты.</span>
      </div>
    </section>
  `;
}

function teamEducationCard(){
  return `
    <section class="edu-card edu-card-team" aria-label="Образовательная карточка Команда">
      <div class="edu-card-head">
        <span class="edu-card-kicker">Перед заполнением</span>
        <h3>Команда доказывает, что план проекта можно выполнить</h3>
        <p>Эксперт оценивает не должности и количество людей, а то, кто отвечает за ключевые задачи и обладает нужными компетенциями. Роль показывает вклад человека в проект, а релевантный опыт подтверждает его способность этот вклад обеспечить.</p>
      </div>

      <div class="edu-expert-box">
        <div class="edu-box-title">Что хотят увидеть эксперты</div>
        <div class="edu-expert-grid">
          <span>руководителя, отвечающего за проект в целом</span>
          <span>связь ролей с задачами и мероприятиями</span>
          <span>необходимые компетенции и подтверждающий опыт</span>
          <span>исполнителей для всех критически важных функций</span>
          <span>понятное разделение команды, внешних специалистов и резерва</span>
        </div>
      </div>
      ...
      <div class="edu-examples">
        <article class="edu-example edu-example-good">
          <div class="edu-example-label">Хороший пример</div>
          <p><b>Руководитель проекта:</b> управляет календарным планом, координирует площадки и отвечает за выполнение задач; ранее руководил тремя муниципальными молодёжными проектами.</p>
          <p><b>Методист-профориентолог:</b> разрабатывает программу проб и инструменты анализа опыта; пять лет работает с профессиональным выбором подростков.</p>
          <p><b>Координатор наставников:</b> привлекает и готовит специалистов, сопровождает проведение проб; имеет опыт организации программ с работодателями.</p>
          <p><b>Аналитик:</b> проводит входное и итоговое анкетирование, обрабатывает личные карты участников и фиксирует результаты проекта.</p>
          <p>Для отдельных профессиональных направлений привлекаются внешние наставники; предусмотрен резерв специалистов.</p>
          <small>Почему сильный: у каждого участника есть конкретная зона ответственности, компетенции связаны с мероприятиями, а ключевые функции проекта обеспечены исполнителями.</small>
        </article>
        <article class="edu-example edu-example-weak">
          <div class="edu-example-label">Слабый пример</div>
          <p>В команду входят директор организации, бухгалтер, педагоги и волонтёры. Все являются опытными специалистами и будут участвовать в проекте по мере необходимости.</p>
          <small>Почему слабый: перечислены должности, но не проектные роли. Неясно, кто отвечает за программу, наставников, мероприятия и оценку результатов, а релевантный опыт не подтверждён.</small>
        </article>
      </div>
      ...
      <div class="edu-support-grid">
        <div class="edu-support-card">
          <div class="edu-box-title">Типичные ошибки</div>
          <ul>
            <li>заменять проектные роли штатными должностями;</li>
            <li>перечислять компетенции без примеров релевантного опыта;</li>
            <li>не связывать участников с задачами и мероприятиями;</li>
            <li>оставлять ключевые функции без ответственных или резерва;</li>
            <li>смешивать команду, партнёров, подрядчиков и волонтёров без объяснения их вклада.</li>
          </ul>
        </div>
        <div class="edu-support-card">
          <div class="edu-box-title">Самопроверка</div>
          <ul class="edu-check-list">
            <li>Понятно ли, за что отвечает руководитель проекта?</li>
            <li>Есть ли ответственный за каждую ключевую задачу?</li>
            <li>Соответствуют ли компетенции участников содержанию проекта?</li>
            <li>Подтверждён ли опыт фактами и релевантными примерами?</li>
            <li>Есть ли исполнитель или резерв для каждой критически важной функции?</li>
          </ul>
        </div>
      </div>
      ...
      <div class="edu-work-link">
        <b>Как работать дальше:</b>
        <span>сначала распределите внутреннюю ответственность и убедитесь, что команда закрывает все ключевые функции проекта. Затем переходите к партнёрам и отделяйте обязанности команды от внешней поддержки.</span>
      </div>
    </section>
  `;
}
...
function renderProjectSection(sectionId){
  ...
  const educationCards = {
    ...
    goalsTasks: goalsEducationCard,
    implementation: implementationEducationCard,
    results: resultsEducationCard,
    team: teamEducationCard
  };
