  ...
  return `
    <section class="edu-card edu-card-diagnostic" aria-label="Образовательная карточка Первичная диагностика">
      <div class="edu-card-head">
        ...
        <h3>Первичная диагностика — это навигация по проекту</h3>
        <p>Перед заявкой важно честно понять, в каком состоянии находится проект сейчас: это ещё идея, собранная инициатива, оформленный проект, проверенная практика или модель для масштабирования. Диагностика помогает не писать красивый текст поверх слабой логики, а увидеть, что уже собрано, какие пробелы нужно закрыть и какие риски могут помешать старту.</p>
      </div>

      <div class="edu-expert-box">
        <div class="edu-box-title">Что хотят увидеть эксперты</div>
        <div class="edu-expert-grid">
          <span>на какой стадии реально находится проект</span>
          <span>не завышена ли его готовность</span>
          <span>видит ли команда слабые места</span>
          <span>есть ли связь между проблемой, аудиторией и решением</span>
          <span>названы ли конкретные риски старта</span>
          <span>понятно ли, какие разделы нужно усилить дальше</span>
        </div>
      </div>
      ...
      <div class="edu-examples">
        <article class="edu-example edu-example-good">
          ...
          <h4>«Городская мастерская первых профессиональных проб»</h4>
          <p><b>Стадия проекта:</b> инициатива. <b>Уровень готовности:</b> средний. Мы видим устойчивый запрос подростков на практическое знакомство с профессиями до выбора дальнейшей образовательной траектории. Уже есть идея цикла коротких встреч с наставниками, пробных заданий и обсуждения опыта после каждой встречи. Предварительно подтверждён интерес со стороны педагогов и нескольких специалистов, готовых провести первые занятия.</p>
          <p><b>Что требует доработки:</b> нужно сузить целевую группу, собрать подтверждения потребности от подростков и родителей, закрепить площадки, описать календарный план и показатели результата. <b>Риски старта:</b> часть партнёрских договорённостей пока устная, не выбран способ сбора обратной связи, не до конца понятен объём ресурсов на первый цикл.</p>
          <small>Почему сильный: автор не выдаёт инициативу за полностью готовый проект, но показывает реальную основу, честно называет пробелы и понимает, какие разделы нужно усилить дальше.</small>
        </article>
        <article class="edu-example edu-example-weak">
          ...
          <p><b>Стадия проекта:</b> проект. <b>Уровень готовности:</b> высокий. Мы хотим провести полезные профориентационные мероприятия для школьников, чтобы помочь им лучше понять будущую профессию. В проекте будут встречи с интересными людьми, практические занятия и итоговое мероприятие. Партнёров планируем привлечь в процессе, бюджет рассчитаем после уточнения программы, результаты будут выражаться в повышении интереса участников.</p>
          <small>Почему слабый: идея понятна и жизнеспособна, но готовность завышена. Неясно, какая именно группа школьников участвует, чем подтверждена потребность, кто уже готов поддержать проект, какие ресурсы нужны и как будет проверяться результат.</small>
        </article>
      </div>
      ...
      <div class="edu-support-grid">
        <div class="edu-support-card">
          ...
          <ul>
            <li>считать, что сильная идея уже равна готовому проекту;</li>
            <li>завышать уровень готовности, чтобы выглядеть убедительнее;</li>
            <li>начинать с мероприятий, а не с проблемы и аудитории;</li>
            <li>отмечать слишком мало слабых мест из страха “испортить” проект;</li>
            <li>воспринимать риск как провал, а не как управляемую задачу;</li>
            <li>не фиксировать отсутствие подтверждений, партнёров, ресурсов или показателей;</li>
            <li>описывать проект как “для всех”, без конкретной группы людей.</li>
          </ul>
        </div>
        <div class="edu-support-card">
          <div class="edu-box-title">Самопроверка</div>
          <ul class="edu-check-list">
            <li>могу ли я объяснить, почему выбрана именно эта стадия проекта;</li>
            <li>не завышен ли уровень готовности;</li>
            <li>понятно ли, какие слабые места нужно закрыть первыми;</li>
            <li>названы ли реальные риски старта;</li>
            <li>есть ли первичные подтверждения проблемы или план их собрать;</li>
            <li>ясно ли, какие следующие разделы конструктора помогут усилить проект.</li>
          </ul>
        </div>
      </div>
      ...
      <div class="edu-work-link">
        ...
        <span>выберите стадию и уровень готовности честно, а не “для красоты”. Затем отметьте слабые места и риски как рабочий список доработки. Если основные пробелы связаны с проблемой, аудиторией или доказательствами — сначала усиливайте эти разделы. Если риски связаны с командой, партнёрами, ресурсами или сроками — используйте следующие блоки, чтобы превратить риск в понятный план действий.</span>
      </div>
    </section>
  `;
}
  ...
  return `
    <section class="edu-card edu-card-passport" aria-label="Образовательная карточка Паспорт проекта">
      <div class="edu-card-head">
        ...
        <p>Здесь эксперт быстро считывает, что это за проект, где он реализуется, к какой теме относится, какого он масштаба и кто за него отвечает. Если паспорт размытый, остальные разделы будут восприниматься с недоверием.</p>
      </div>

      <div class="edu-expert-box">
        <div class="edu-box-title">Что хотят увидеть эксперты</div>
        <div class="edu-expert-grid">
          <span>понятное название, связанное с содержанием проекта</span>
          <span>краткое описание без лозунгов и лишней “красоты”</span>
          <span>соответствие тематики, типа проекта и формата работы</span>
          <span>реалистичный масштаб и конкретную территорию</span>
          <span>понятного автора, команду или организацию-заявителя</span>
          <span>ключевые теги, которые помогают отнести проект к нужной сфере</span>
        </div>
      </div>
      ...
      <div class="edu-examples">
        <article class="edu-example edu-example-good">
          <div class="edu-example-label">Хороший пример</div>
          <h4>«Первые пробы: мастерская выбора профессии для подростков»</h4>
          <p><b>Краткое описание:</b> проект помогает подросткам 14–17 лет из муниципального округа Новые Берега попробовать разные профессиональные роли через короткие практические занятия с наставниками. Участники выполняют реальные мини-задания, обсуждают опыт и собирают личную карту дальнейших образовательных шагов.</p>
          <p><b>Тематика:</b> кадры, образование и просвещение; молодёжные инициативы. <b>Тип:</b> образовательный. <b>Масштаб:</b> муниципальный. <b>Территория:</b> муниципальный округ Новые Берега. <b>Заявитель:</b> инициативная команда педагогов и карьерных консультантов на базе молодёжного центра.</p>
          <small>Почему сильный: уже из паспорта понятно, для кого проект, что именно происходит, где он реализуется и кто способен его вести.</small>
        </article>
        <article class="edu-example edu-example-weak">
          <div class="edu-example-label">Слабый пример</div>
          <h4>«Шаг в будущее»</h4>
          <p>Проект направлен на развитие молодёжи, раскрытие потенциала и создание новых возможностей. Планируются мероприятия, встречи и полезные активности для школьников и студентов региона.</p>
          <small>Почему слабый: название красивое, но не объясняет содержание. Аудитория слишком широкая, территория размыта, тип проекта неочевиден, а заявитель и реальная рамка реализации не считываются.</small>
        </article>
      </div>
      ...
      <div class="edu-support-grid">
        <div class="edu-support-card">
          <div class="edu-box-title">Типичные ошибки</div>
          <ul>
            <li>название не связано с реальным содержанием проекта;</li>
            <li>описание звучит как слоган, а не как краткая суть;</li>
            <li>тематика выбрана слишком широко или “на всякий случай”;</li>
            <li>масштаб заявлен больше, чем подтверждают ресурсы;</li>
            <li>территория указана расплывчато;</li>
            <li>неясно, кто отвечает за проект и почему ему можно доверять.</li>
          </ul>
        </div>
        <div class="edu-support-card">
          <div class="edu-box-title">Самопроверка</div>
          <ul class="edu-check-list">
            ...
            <li>можно ли пересказать суть проекта за 20–30 секунд;</li>
            <li>совпадают ли тематика, тип, масштаб и описание;</li>
            <li>достаточно ли конкретно указана территория;</li>
            <li>видно ли, кто является автором или заявителем;</li>
            <li>не обещает ли паспорт больше, чем проект реально может выполнить.</li>
          </ul>
        </div>
      </div>
      ...
      <div class="edu-work-link">
        <b>Как работать дальше:</b>
        <span>заполните паспорт как короткую и честную карточку проекта. Не пытайтесь вместить сюда всю заявку: подробности появятся в разделах про проблему, аудиторию, реализацию и результаты.</span>
      </div>
    </section>
  `;
}
  ...
  return `
    <section class="edu-card edu-card-problem" aria-label="Образовательная карточка Проблема">
      <div class="edu-card-head">
        ...
        <p>Эксперт поддерживает не красивую идею, а решение реальной подтверждённой проблемы. В этом разделе важно показать, что именно не работает сейчас, кого это затрагивает, почему ситуация сохраняется и чем она подтверждается. Пока проблема не ясна, цель, мероприятия, результаты и бюджет будут выглядеть случайными.</p>
      </div>
      ...
      <div class="edu-expert-box">
        ...
        <div class="edu-expert-grid">
          ...
          <span>связь проблемы с территорией и целевой аудиторией</span>
          <span>причины, из-за которых проблема сохраняется</span>
          <span>актуальность именно сейчас</span>
          <span>подтверждения: данные, наблюдения, обращения, опросы, опыт работы</span>
          <span>отсутствие преждевременного рассказа о решении</span>
        </div>
      </div>
      ...
      <div class="edu-examples">
        <article class="edu-example edu-example-good">
          <div class="edu-example-label">Хороший пример</div>
          <p>В муниципальном округе Новые Берега подростки 14–17 лет часто выбирают дальнейшее обучение без практического понимания профессий и требований к ним. По наблюдениям педагогов и карьерных консультантов, школьники называют интересные направления, но слабо представляют реальные задачи специалистов, нужные навыки и возможные образовательные маршруты.</p>
          <p>Проблема сохраняется из-за нехватки доступных форматов профессиональных проб: профориентация чаще проходит в виде бесед, тестов или разовых встреч, после которых у подростков остаётся мало личного опыта для выбора. Актуальность подтверждается обращениями родителей, вопросами школьников на консультациях и результатами короткого опроса участников молодёжного центра.</p>
          <small>Почему сильный: проблема конкретная, связана с аудиторией и территорией, названы причины и есть первичные подтверждения. Текст пока не уходит в описание будущего проекта.</small>
        </article>
        <article class="edu-example edu-example-weak">
          <div class="edu-example-label">Слабый пример</div>
          <p>Молодёжи сегодня сложно выбрать профессию, поэтому нужно проводить больше полезных мероприятий, встреч и мастер-классов. Наш проект поможет школьникам раскрыть потенциал, повысить мотивацию и уверенно смотреть в будущее.</p>
          <small>Почему слабый: проблема звучит общо, аудитория не уточнена, территория не видна, подтверждений нет. Вместо анализа ситуации сразу начинается рассказ о том, что проект будет делать.</small>
        </article>
      </div>
      ...
      <div class="edu-support-grid">
        <div class="edu-support-card">
          ...
          <ul>
            ...
            <li>писать “это важно для всех” без конкретной аудитории;</li>
            <li>не показывать, почему проблема актуальна именно на этой территории;</li>
            <li>не объяснять причины проблемы;</li>
        ...
        <div class="edu-support-card">
          ...
          <ul class="edu-check-list">
            ...
            <li>ясно ли, кого проблема затрагивает;</li>
            <li>связана ли проблема с территорией проекта;</li>
            <li>названы ли причины, а не только последствия;</li>
            <li>есть ли хотя бы первичные подтверждения;</li>
            <li>можно ли из проблемы логично вывести цель и будущие результаты.</li>
          </ul>
        </div>
      </div>
      ...
      <div class="edu-work-link">
        <b>Как работать дальше:</b>
        <span>сначала опишите проблему без решения: ситуация, аудитория, территория, причины и подтверждения. После этого переходите к целевой аудитории — там нужно будет точнее показать, кто именно сталкивается с этой проблемой и какие потребности у этих людей есть.</span>
      </div>
    </section>
  `;
}
